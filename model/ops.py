...
def set_weights(file_handler):
    
    cnn_weight_dict={}
    cnn_weight_dict['conv1/w:0'] = file_handler['conv1/conv1.W:0'][...]
    cnn_weight_dict['conv2/w:0'] = file_handler['conv2/conv2.W:0'][...]
    cnn_weight_dict['conv3/w:0'] = file_handler['conv3/conv3.W:0'][...]
    cnn_weight_dict['BatchNorm/beta:0'] = file_handler['conv3//beta:0'][...]
    cnn_weight_dict['BatchNorm/moving_mean:0'] = file_handler['conv3//moving_mean:0'][...]
    cnn_weight_dict['BatchNorm/moving_variance:0'] = file_handler['conv3//moving_variance:0'][...]

    cnn_weight_dict['conv4/w:0'] = file_handler['conv4/conv4.W:0'][...]
    cnn_weight_dict['conv5/w:0'] = file_handler['conv5/conv5.W:0'][...]
    cnn_weight_dict['BatchNorm_1/beta:0'] = file_handler['conv5//beta:0'][...]
    cnn_weight_dict['BatchNorm_1/moving_mean:0'] = file_handler['conv5//moving_mean:0'][...]
    cnn_weight_dict['BatchNorm_1/moving_variance:0'] = file_handler['conv5//moving_variance:0'][...]

    cnn_weight_dict['conv6/w:0'] = file_handler['conv6/conv6.W:0'][...]
    cnn_weight_dict['BatchNorm_2/beta:0'] = file_handler['conv6//beta:0'][...]
    cnn_weight_dict['BatchNorm_2/moving_mean:0'] = file_handler['conv6//moving_mean:0'][...]
    cnn_weight_dict['BatchNorm_2/moving_variance:0'] = file_handler['conv6//moving_variance:0'][...]
    

    return cnn_weight_dict
